...
`@@uniorgjs` can turn import statements (`import x from 'y'`) into dynamic
...
`@@uniorgjs` is a unified pipeline — wrapped so that most folks don’t need to
...
But it’s where `@@uniorgjs` does its thing: where it adds imports/exports,
...
[core]: https://github.com/rasendubi/uniorg/blob/main/packages/orgx/lib/core.js#L65
